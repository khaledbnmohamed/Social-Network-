...
class Post {
	...
	public function submitPost($body, $user_to, $imageName) {
		...
		if($check_empty != "") {
			...
			//insert post 
$query = mysqli_query($this->con, "INSERT INTO posts VALUES('', '$body', '$added_by', '$user_to', '$date_added', 'no', 'no', '0', '$imageName','yes')");			$returned_id = mysqli_insert_id($this->con);
	...
	public function loadPostsFriends($data, $limit) {
		...
		if(mysqli_num_rows($data_query) > 0) {
			...
			if($imagePath != "") {
						$imagePath = "<div class='postedImage'>
										<img src='$imagePath'>
									</div>";
					}
					else {
...
//*	$imageDiv 
	...
	public function makePrivate($post_id){
		$opened_query = mysqli_query($this->con, "UPDATE posts SET is_public='no' WHERE id='$post_id'");
