...
//$dateOfBirth = $_POST['year']."-". $_POST['month']."-".$_POST['day'];
	...
	$gender=$_POST['gender'];
	$_SESSION['gender'] = $gender; //Stores email2 into session variable
	...
	if(empty($error_array)) {
		...
		$query = mysqli_query($con, "INSERT INTO users VALUES ('', '$fname', '$lname', '$username', '$em', '$password', '$date', '$profile_pic', '0', '0', 'no', ',','$bdate','$gender','$marital_status','$hometown','$nickname')");
